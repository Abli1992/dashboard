...
@Component({
  ...
  <mat-card class="table-card">
    <div class="section-header">
      <h2 style="margin:0;">Missing Invoices</h2>
  ...
  <mat-card style="margin-top:16px;">
    <div class="section-header">
      <h3 style="margin:0;">Missing Invoices — Service</h3>
    ...
    <div *ngIf="!enabled" class="enable-card">
      <div>
        ...
        <button mat-flat-button color="primary">Enable Missing Invoices</button>
      </div>
    </div>
  </mat-card>
  `
})
export class MissingInvoicesComponent {
  fromDate = '2024-01-01';
  toDate = '2024-12-31';
