...
@Component({
  ...
  <mat-card class="table-card">
    <div class="section-header">
      <h2 style="margin:0;">Price Claims</h2>
  ...
  <mat-card style="margin-top:16px;">
    <div class="section-header">
      <h3 style="margin:0;">Price Claims — Service</h3>
    ...
    <div *ngIf="!enabled" class="enable-card">
      <div>
        ...
        <button mat-flat-button color="primary">Enable Price Claims</button>
      </div>
    </div>
  </mat-card>
  `
})
export class PriceClaimsComponent {
  fromDate = '2024-01-01';
  toDate = '2024-12-31';
